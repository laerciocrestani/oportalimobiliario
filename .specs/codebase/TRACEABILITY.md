...
| REQ-RES-006 | Confirmar pre-hold (vincular cliente) | `PreReservationService.php`, `Broker/ReservationController.php` | `BrokerPreHoldDialog.tsx`, `BrokerUnitsDialog.tsx` | `PreReservationTest.php`, `BrokerPreHoldDialog.test.tsx` |
| REQ-RES-007 | Liberar pre-hold | `PreReservationService.php`, `Broker/ReservationController.php` | `BrokerPreHoldDialog.tsx` | `PreReservationTest.php`, `BrokerPreHoldDialog.test.tsx` |
