...
- **Última etapa concluída:** TR-03 — `PUT .../unit-grid` com vagas, `customized` e códigos `101`/`L01`/`S1-01`
- **Próxima etapa:** TR-04 — publish exige `price_base` em unidades/vagas `available`; serializar `floor.kind`/`customized`
